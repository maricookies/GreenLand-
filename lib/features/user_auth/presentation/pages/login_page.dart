...
import 'package:greenland_organicfarm/features/user_auth/firebase_auth_implementation/firebase_auth_services.dart';
...
import 'package:greenland_organicfarm/features/user_auth/presentation/widgets/form_container_widget.dart';
...
void _forgotPassword() {
  String email = _emailController.text;
  _notificationService.sendPasswordResetNotification(email);
  showToast(message: 'Password reset instructions sent to $email');
}
}
